...
## Halaman 1 — Performa Konten & Engagement

### 1.1 Performa Konten per Kategori
...
### 1.3 Analisis Konten Evergreen vs Fresh
...
### 1.5 Konten dengan Format Video vs Non-Video
...
### 1.6 Artikel Breaking vs Headline — Perbedaan Engagement
...
## Halaman 2 — Editorial & Penulis

### 2.1 Performa Penulis (Author Performance)
...
### 2.2 Heatmap Waktu Rilis Terbaik
...
### 2.3 Jalur Sebelum Author Profile View
...
## Halaman 3 — Discovery, Search & Navigasi

### 3.1 Corong Discovery → Baca
...
### 3.2 Efektivitas Posisi Klik pada Kartu Artikel
...
### 3.4 Jalur Setelah Select Content
...
### 3.5 Jalur Discovery dari Search ke Baca
...
## Halaman 4 — Traffic & Akuisisi

### 4.1 Distribusi Channel Traffic
...
## Halaman 5 — Iklan & Monetisasi

### 5.1 Corong Konversi Iklan (Ad CTR)
...
### 5.2 Performa Iklan per Sponsor
...
### 5.3 Irisan Efektivitas Iklan × Tipe User
...
## Halaman 6 — Push Notification

### 6.1 Corong Push Notification → Baca Sampai Selesai
...
### 6.3 Cohort Pembaca Push Notification
...
## Halaman 7 — Audiens & Retensi

### 7.1 Segmentasi Logged-in vs Guest
...
### 7.2 Retensi Berdasarkan Tipe User
...
### 7.3 Irisan Tipe Pembaca × Channel × Format Konten
...
### 7.4 Irisan Pembaca Aktif × Kategori × Share
...
| --------- | -------------------------------- | ---------------------------------------------------- |
| 🔴 Tinggi | 1.1 Performa Konten per Kategori | Paling langsung berguna untuk editorial decision     |
| 🔴 Tinggi | 1.2 Corong Loyalitas Artikel     | Ukur kesehatan konten secara keseluruhan             |
| 🔴 Tinggi | 2.2 Heatmap Waktu Rilis          | Actionable: mengubah jadwal rilis langsung impactful |
| 🔴 Tinggi | 5.1 Corong Konversi Iklan        | Langsung berdampak pada revenue iklan                |
| 🟡 Sedang | 2.1 Performa Penulis             | Berguna untuk review tim konten                      |
| 🟡 Sedang | 3.3 Analisis Search Internal     | Identifikasi gap konten                              |
| 🟡 Sedang | 3.4 Jalur Setelah Select Content | Optimasi UX layout kartu                             |
| 🟢 Rendah | 7.3–7.4 Segment Overlap          | Berguna saat data sudah banyak (>30 hari)            |
| 🟢 Rendah | 7.2 User Lifetime                | Perlu data minimal 4–8 minggu untuk bermakna         |
