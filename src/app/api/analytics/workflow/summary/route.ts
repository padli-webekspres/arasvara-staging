...
import { getWorkflowSummary } from "@/services/analytics/workflowAnalyticsService";
...
export async function GET(req: NextRequest) {
  try {
    ...
    // Workflow is org-wide; self-scoped editors cannot access
    ...
    const summary = await getWorkflowSummary(db, startDate, endDate);
    ...
    console.error("Error pada GET /api/analytics/workflow/summary:", error);
